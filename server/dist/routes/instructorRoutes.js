...
const instructorController = new instructorController_1.InstructorController(instructorService);
...
instructorRouter.put('/modules/:moduleId', currentUser_1.isUserAuth, (req, res, next) => instructorController.updateModule(req, res, next));
instructorRouter.delete('/modules/:moduleId', currentUser_1.isUserAuth, (req, res, next) => instructorController.deleteModule(req, res, next));
